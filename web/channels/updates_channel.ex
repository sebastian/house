defmodule House.UpdatesChannel do
  ...
  defp set_mode("presence_only"), do: House.Mode.presence_only()
  defp set_mode("night"), do: House.Mode.night()
  defp set_mode(other), do: Logger.warn("Unknown mode: #{inspect other}")
end
